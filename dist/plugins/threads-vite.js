"use strict";var $=Object.create;var p=Object.defineProperty;var b=Object.getOwnPropertyDescriptor;var A=Object.getOwnPropertyNames;var w=Object.getPrototypeOf,x=Object.prototype.hasOwnProperty;var _=(e,t)=>{for(var a in t)p(e,a,{get:t[a],enumerable:!0})},g=(e,t,a,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of A(t))!x.call(e,n)&&n!==a&&p(e,n,{get:()=>t[n],enumerable:!(s=b(t,n))||s.enumerable});return e};var T=(e,t,a)=>(a=e!=null?$(w(e)):{},g(t||!e||!e.__esModule?p(a,"default",{value:e,enumerable:!0}):a,e)),F=e=>g(p({},"__esModule",{value:!0}),e);var O={};_(O,{default:()=>C,threadsPlugin:()=>y});module.exports=F(O);var o=T(require("fs")),d=T(require("path")),v=require("esbuild");function P(e){if(!e.hasThread)return"";let t=e.name.replace(/-/g,"_");return`
...
${a}
${i}${f}${h}
`}async function m(e={}){let{threadsDir:t="src/threads",output:a="public/worker.js",minify:s=!1,sourcemap:n=!1,target:r="es2020"}=e,i=d.resolve(process.cwd(),t),f=d.resolve(process.cwd(),a),h=await H(i);if(h.length===0){console.warn(`No threads found in ${t}`);return}console.log(`Found ${h.length} thread(s): ${h.map(u=>u.name).join(", ")}`);let c=S(h),l=d.join(i,"__sw-entry__.ts");o.writeFileSync(l,c,"utf-8");try{await(0,v.build)({entryPoints:[l],bundle:!0,outfile:f,format:"iife",platform:"browser",target:Array.isArray(r)?r:[r],minify:s,sourcemap:n,write:!0}),console.log(`\u2713 Built worker.js at ${a}`)}finally{o.existsSync(l)&&o.unlinkSync(l)}}function y(e={}){let{threadsDir:t="src/threads",output:a="public/worker.js",minify:s,sourcemap:n,target:r}=e;return{name:"servex-thread-threads",async buildStart(){try{await m({threadsDir:t,output:a,minify:s,sourcemap:n,target:r})}catch(i){this.error(`Failed to build threads: ${i}`)}},async handleHotUpdate({file:i}){if(i.includes(t))try{await m({threadsDir:t,output:a,minify:s,sourcemap:n,target:r}),console.log("\u2713 Threads rebuilt")}catch(f){console.error(`Failed to rebuild threads: ${f}`)}}}}var C=y;0&&(module.exports={threadsPlugin});
