#!/usr/bin/env node
"use strict";var g=Object.create;var r=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var h=Object.getOwnPropertyNames;var b=Object.getPrototypeOf,m=Object.prototype.hasOwnProperty;var f=(o,e,n,l)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of h(e))!m.call(o,s)&&s!==n&&r(o,s,{get:()=>e[s],enumerable:!(l=p(e,s))||l.enumerable});return o};var y=(o,e,n)=>(n=o!=null?g(b(o)):{},f(e||!o||!o.__esModule?r(n,"default",{value:o,enumerable:!0}):n,o));var i=require("child_process"),c=y(require("readline"));function d(o){let e=c.createInterface({input:process.stdin,output:process.stdout});return new Promise(n=>{e.question(o,l=>{e.close(),n(l.trim())})})}async function t(o){let e=await d(`${o} (y/n): `);return e.toLowerCase()==="y"||e.toLowerCase()==="yes"}async function w(o,e){console.log(`
${o}`),e.forEach((s,u)=>{console.log(`  ${u+1}. ${s}`)});let n=await d(`
Enter your choice (1-`+e.length+"): "),l=parseInt(n)-1;return l>=0&&l<e.length?e[l]:(console.log("Invalid choice, defaulting to first option."),e[0])}function a(o,e=!1){let l=`npm install ${e?"-D":""} ${o.join(" ")}`;console.log(`
\u{1F4E6} Installing: ${o.join(", ")}...`);try{(0,i.execSync)(l,{stdio:"inherit"}),console.log(`\u2705 Installation complete!
...
\u{1F4CB} Summary:`),console.log("  - Remedy Thread: \u2705 (already installed)"),console.log(`  - esbuild: ${e.installEsbuild?"\u2705":"\u274C"}`),console.log(`  - Bundler: ${e.bundler||"Already installed"}`);let n=[],l=[];e.installEsbuild&&n.push("esbuild"),e.bundler&&e.bundler!=="none"&&l.push(e.bundler),n.length>0&&a(n,!1),l.length>0&&a(l,!0),console.log(`
